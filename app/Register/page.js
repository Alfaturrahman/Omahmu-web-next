...
import { registerCustomer } from '../../services/authService'; // Mengimpor fungsi registerCustomer
...
const Register = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        phoneNumber: '',
        password: '',
        confirmPassword: '', // Menambahkan field confirmPassword
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const payload = {
                ...
                phoneNumber: selectedCountry + formData.phoneNumber, // Gabungkan kode negara dengan nomor
            ...
            if (response.messagetype === 'S') {
                ...
                // Anda bisa mengarahkan pengguna ke halaman lain setelah berhasil
            } else {
            ...
            <div className="flex flex-col md:flex-row w-full max-w-md md:max-w-4xl h-auto md:h-150 rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="w-full md:w-1/2 bg-white p-6 md:p-10 flex flex-col justify-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="noHp" className="text-black block mb-1 font-bold">
                                No WhatsApp
                            </label>
